...
public class AdminService {
    ...
    public Page<Admin> searchUsers(String name, Pageable pageable) {
    ...
    public void save(AdminInsertRequest request) {
        ...
        if (request.getFile() != null && !request.getFile().isEmpty()) {
            attachmentService.upload(admin.getId(), OwnerType.USER, request.getFile());
        }
    }
    ...
    public void update(AdminUpdateRequest request) {
        Admin user = repository.findById(request.getId())
